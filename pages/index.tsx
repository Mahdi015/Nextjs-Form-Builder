...
import { selectForms, updateForm } from "../slices/formsSlice";
          ...
          {values && values.length !== 0 ? (
            <>
              ...
              <div className="flex flex-wrap justify-center items-center  gap-4">
                {values &&
                  values.map((f, i) => (
                    <div key={i} className="group flex justify-center flex-col bg-formbg p-7 rounded-xl hover:shadow-inputboxshadow transition duration-200 ease-in transform hover:scale-105  h-56">
                      <Image
                      ...
                      <h1
                        onClick={() => router.push(`/forms/${f.id}`)}
                        className="text-center cursor-pointer capitalize  font-semibold"
                      >
                        {f.name}
                      </h1>
